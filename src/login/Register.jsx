...
const Register = () => {
  ...
  return (
    ...
    <h1 className='text-center font-bold text-[25px]'>SIGN UP</h1>
      ...
      <div className="mb-4">
        ...
        <button  type='submit' className="bg-indigo-500  text-white py-2 px-4 rounded focus:outline-none focus:bg-indigo-500  font-monserrat">
          sign up
        </button>
        <span className='font-monserrat' >Already have an account?<Link to="/" className='text-indigo-600'>Login</Link> </span>
        {/* <Link
          to="/forgot-password"
