...
const Hero = () => {
  ...
  return (
    ...
    <p  className="text-xl font-montserrat text-coral-red mt-4">
      Our Summer Collection
    </p>
    <h1 className="mt-10 font-palanquin text-8xl text-[82px] font-bold">
  ...
  <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14">
    Discover stylish Nike arrivals, qulity comfort, and innovation for your active life.
  </p>
  ...
  <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
    ...
    <div className="relative flex-1 flex justify-center items-center
     xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
      <img src={bigShoeImg} alt="shoes collecton" width={610} height={500} 
